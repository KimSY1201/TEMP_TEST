...
from gui_4 import OutputModule, DataSignal, GLOBAL_STYLESHEET # gui_4에서 스타일시트도 가져옵니다.
...
if __name__ == '__main__':
    ...
    receiver = ReceiverModule(output_queue, detection_queue, port='COM3', baudrate=38400)
    ...
    detection_module = DetectionModule(detection_queue, threshold=5.0, filename="detected_values.txt")
