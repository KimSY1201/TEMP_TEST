...
def process_data_to_image1(data_64_columns, sigma=1.0, output_shape=(24, 24), plot_results=True):
    ...
    filtered_24x24 = gaussian_filter(array_8x8, sigma=sigma)
    array_24x24 = zoom(filtered_24x24, zoom=(zoom_factor_h, zoom_factor_w), order=3)
...
def process_wrapper_with_data(row_idx, pixel_data_values, sigma, output_shape, pdti=process_data_to_image1):
    ...
    processed_image_2d = pdti(pixel_data_values, sigma=sigma, output_shape=output_shape)
...
if __name__ == '__main__':
    ...
    fdf_parallel_result.to_csv('./f24_hn_thermal.csv', encoding='utf-8')